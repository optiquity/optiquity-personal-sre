...
| 14 | [Monitoring](14-monitoring.md) | Knowing it works and hearing when it doesn't: health checks, coverage probes for batch work, alerting, and the update digest. |
