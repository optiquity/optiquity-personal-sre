...
cross-session messaging between the agents that own your repos, the permission boundary it opens, and
a **versioned standard that propagates peer to peer** rather than from a shared location.
