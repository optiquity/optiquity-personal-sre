...
**Section A — install-and-keep-current tools.** Back to the [catalog](../20-example-projects.md).
...
[E10 · Fleet-update pass](E10-fleet-update-pass.md) · [catalog](../20-example-projects.md).
